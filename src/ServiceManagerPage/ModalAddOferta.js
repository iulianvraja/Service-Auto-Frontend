...
class ModalAddOferta extends React.Component {
    ...
    render() {
        return (
           ...
           <Label for='ofertaField'>Oferta Dumneavoastra: </Label>
            <input  onChange={this.handleChange} name="oferta" type="text" list="oferts" />
             <datalist id="oferts">
              ...
              <option name='oferta'>{d}</option>
                ...
                <FormGroup id='cod_reparatie'>
                                   ...
                                   <select name='cod_reparatie' onChange={this.handleChange}>
                ...
                <FormGroup id='durata_reparatieField'>
                                    <Label for='durata_reparatieField'>Durata Medie, estimata in zile: </Label>
                                    <Input name='durata_reparatie' id='durata_reparatie'
                                           onChange={this.handleChange}
                                           required
                                    />
                                </FormGroup>
                ...
                <Row>
                    <Col sm={{size: '4', offset: 8}}>
                        <Button type={"submit"} href="/managerpage" onClick={this.handleSubmit}> Submit </Button>
                    </Col>
                </Row>
